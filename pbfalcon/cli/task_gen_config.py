...
def add_args_and_options(p):
    ...
    p.add_boolean("falcon_ns.task_options." + gen_config.OPTION_SAVE_LAS_FOR_UNZIP, "save-las-for-unzip", False,
            "Save Output for Unzip", "Saves certain files that enable running unzip via command line")
    return p
